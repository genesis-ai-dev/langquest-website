        ...
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <div className="space-y-4 mt-12">
            ...
            <div className="prose prose-gray dark:prose-invert">
              ...
              <p>
                We are committed to protecting your privacy. We collect minimal
                data necessary to provide you with the App&apos;s functionality,
                as outlined in this policy.
              </p>
              <p>
                Frontier R&D is based in Canada, and this Privacy Policy is
                governed by and construed in accordance with Canadian law.
              ...
              <p>
                ...
                users from all countries and regions. Our mission is to preserve
                and make language data accessible globally, and we are committed
                to respecting privacy laws in the various jurisdictions where
                our users reside.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4 mt-12">
            ...
            <div className="prose prose-gray dark:prose-invert space-y-4">
              ...
              <p>
                We collect the following information that you voluntarily
                provide to us:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Account Information</strong>: When you create an
                  account, we collect your email address (optional, for account
                  recovery purposes) and username.
                </li>
                <li>
                  <strong>User Content</strong>: Any content you contribute to
                  the App, including translations, audio recordings, comments,
                  and votes.
                </li>
                <li>
              ...
              <p>
                When you use our App, we may collect certain information
                automatically, including:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Usage Information</strong>: Information about your
                  interactions with the App, such as the features you use and
                ...
                <li>
                  <strong>Analytics Data</strong>: We use PostHog, an analytics
                  service, to collect usage data to help us improve the App.
                  This may include:
                  <ul className="list-disc pl-6 space-y-2 mt-2">
                    <li>
                      Device metadata: device type, screen dimensions, operating
                      system version, and app version
                    </li>
                    <li>
          ...
          <div className="space-y-4 mt-12">
            ...
            <div className="prose prose-gray dark:prose-invert">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>Improve the App</strong>: To understand how users
                ...
                <li>
                  <strong>Security and compliance</strong>: To protect the App
                  and our users, and to comply with legal obligations.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-4 mt-12">
            ...
            <div className="prose prose-gray dark:prose-invert space-y-4">
              ...
              <p>
                All content you contribute to LangQuest (translations,
                recordings, comments, votes) is made freely available worldwide
                under the CC0 1.0 Universal (CC0 1.0) Public Domain Dedication.
                This means anyone can use this content for any purpose without
                attribution.
              </p>

              <h3 className="text-xl font-bold">
                4.1.1 Our Language Data Mission
              </h3>
              <p>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Analytics</strong>: We use PostHog to collect and
                  analyze usage data. PostHog processes this information on our
                  behalf according to their privacy policy and our instructions.
                </li>
                <li>
                  <strong>Hosting and Infrastructure</strong>: Services that
                  host the App and store user data.
                </li>
              </ul>
          ...
          <div className="space-y-4 mt-12">
            ...
            <div className="prose prose-gray dark:prose-invert">
              <p>
                ...
                destruction. However, no internet or electronic storage system
          ...
          <div className="space-y-4 mt-12">
            ...
            <div className="prose prose-gray dark:prose-invert space-y-4">
              ...
              <p>
                ...
                settings. If you need assistance, please contact us at{' '}
                <a
              ...
              <p>
                If you have subscribed to our newsletter, you can unsubscribe at
                any time by following the unsubscribe link in the emails or by
                contacting us.
              </p>

              <h3 className="text-xl font-bold">6.3 Account Deletion</h3>
              <p>
                You can request the deletion of your account by contacting us at{' '}
                <a
                  href="mailto:admin@frontierrnd.com"
                  className="text-primary underline"
                >
                ...
                . Upon deletion, we will remove your account information from
                our active systems. However, some information may remain in our
                backups or records as required by law.
              </p>
          ...
          <div className="space-y-4 mt-12">
            ...
            <div className="prose prose-gray dark:prose-invert">
              <p>
                The App is not directed to children under the age of 13, and we
          ...
          <div className="space-y-4 mt-12">
            ...
            <div className="prose prose-gray dark:prose-invert">
              <p>
                ...
                service providers maintain facilities. By using the App, you
                consent to the transfer of information to countries outside your
                country of residence, including from Canada to the United
                States, which may have different data protection rules than
              ...
              <p>
                ...
                located in a region with specific data protection laws (such as
                the European Economic Area, United Kingdom, Switzerland, Brazil,
                or other jurisdictions), please understand that by using our
                App, you are consenting to the transfer and processing of your
                information in the United States, which may not provide the same
          ...
          <div className="space-y-4 mt-12">
            ...
            <div className="prose prose-gray dark:prose-invert">
              <p>
                ...
                the App or by other means. Your continued use of the App after
          ...
          <div className="space-y-4 mt-12">
            ...
            <div className="prose prose-gray dark:prose-invert space-y-4">
              <h3 className="text-xl font-bold">11.1 California Residents</h3>
              <p>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  ...
                  including categories of information, purposes for collection,
                  and categories of third parties with whom we&apos;ve shared
                  it.
                </li>
                <li>
              ...
              <h3 className="text-xl font-bold">11.2 International Users</h3>
              <p>
                ...
                protection and other laws of the United States and Canada might
                not be as comprehensive as those in your country. By using our
                App, you consent to your information being transferred to and
