          ...
          <div className="max-w-3xl mx-auto space-y-12">
            <div className="space-y-4 mt-12">
              ...
              <p className="text-lg text-muted-foreground">
                This is the data policy for LangQuest. It outlines our
                philosophy on user data and language data.
              </p>
            </div>
              ...
              <div className="prose prose-gray dark:prose-invert">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    ...
                    share your email address with any third parties. It will
                    only be used for updates about LangQuest.
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-4 mt-12">
              ...
              <div className="prose prose-gray dark:prose-invert space-y-4">
                ...
                <p>
                  To this end, the language gathered or validated in LangQuest
