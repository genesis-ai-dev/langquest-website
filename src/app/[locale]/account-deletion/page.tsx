      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="max-w-3xl mx-auto space-y-12">
            ...
            <div className="prose prose-gray dark:prose-invert">
              ...
              <div className="my-8 p-6 border rounded-lg bg-muted/50">
                ...
                <p className="text-center mt-2 text-muted-foreground">
                  Click the email address above to open your email client with a
          ...
          <div className="space-y-4 mt-12">
            ...
            <div className="prose prose-gray dark:prose-invert">
              <p>
                Upon receiving your deletion request, we will process it within
                30 days. After deletion, we may retain certain data for an
                additional period of up to 90 days in our backup systems before
                it is completely purged.
              </p>
              <p>
                We may also retain certain information if required by law or for
