            ...
            <div className="container mx-auto px-4 md:px-6">
              ...
              <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4 mt-12">
                ...
                <Card className="h-full">
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      Features like leaderboards and rewards make translation
                      fun and encourage participation.
                    </p>
                  </CardContent>
                </Card>
                <Card className="h-full">
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      All validated translations become part of an openly
                      licensed database, helping train future AI models.
                    </p>
                  </CardContent>
                </Card>
              </div>
            ...
            <div className="container mx-auto px-4 md:px-6">
              ...
              <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-3 mt-12">
                <div className="flex flex-col items-center space-y-2 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Organize your translation work into projects, like
                    translating the Bible or important cultural texts.
                  </p>
                </div>
                <div className="flex flex-col items-center space-y-2 text-center">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-accent4 text-white">
                ...
                <div className="flex flex-col items-center space-y-2 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Validate translations through community voting and share
                    them with the world.
                  </p>
                </div>
              </div>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Enable native speakers to validate translations
                          through simple voting
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Work together even without internet through
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Track achievements and milestones to make
                          documentation engaging
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Share validated translations openly to benefit the
                          whole community
                        </p>
                      </div>
                    </div>
