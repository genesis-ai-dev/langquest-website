          ...
          {benefits.map((item, index) => (
            ...
            >
              <div className="flex items-start space-x-4 p-6 bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 group relative overflow-hidden">
                ...
                <div className="flex-shrink-0 w-12 h-12 bg-cosmic-starlight/10 rounded-full flex items-center justify-center text-2xl group-hover:bg-cosmic-starlight/20 transition-colors duration-300">
                  {item.icon}
                </div>
                <div className="flex-1 relative z-10">
                  <h3 className="text-xl font-semibold group-hover:text-cosmic-indigo transition-colors duration-300">
                    {item.title}
                  </h3>
