                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="w-[22%]">Content</TableHead>
                      <TableHead className="w-[7%]">Audio</TableHead>
                              ...
                              <FormItem>
                                <FormControl>
                                  <Textarea
                                    ...
                                    className="min-h-[50px] max-h-[80px] resize-none text-xs bg-primary-foreground"
                                  />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
