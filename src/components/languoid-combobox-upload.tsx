...
interface LanguoidComboboxUploadProps {
  value: string;
...
export function LanguoidComboboxUpload({
  value,
  onChange,
  ...
  const { data: selectedLanguoidById = null } = useQuery({
    ...
    enabled: Boolean(value && !selectedLanguoidFromList)
  });

  const selectedLanguoid = selectedLanguoidFromList || selectedLanguoidById;
